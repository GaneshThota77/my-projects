...
__all__ = [
    'ISpShortcut', 'eLEXTYPE_RESERVED6', 'SAFTGSM610_44kHzMono',
    'SVEAllEvents', 'SAFT24kHz16BitMono', 'ISpeechBaseStream',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFT48kHz8BitStereo',
    'SREAdaptation', 'SpStreamFormatConverter', 'SP_VISEME_7',
    'DISPID_SPIGetText', 'SDTPronunciation', 'DISPID_SPPs_NewEnum',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPSUnknown',
    'DISPID_SPEActualConfidence', 'DISPID_SRGCmdSetRuleState',
    'SPPROPERTYINFO', 'DISPID_SGRsCommit', 'SVSFNLPSpeakPunc',
    'SPINTERFERENCE_TOOLOUD', 'eLEXTYPE_APP', 'DISPID_SGRSTsCount',
    'ISpeechPhraseAlternate', 'SRTEmulated', 'SPSEMANTICERRORINFO',
    'DISPID_SVSInputSentenceLength',
    'DISPID_SRCAudioInInterferenceStatus',
    'SpeechGrammarRuleStateTransitionType', 'SGDSInactive',
    'SECFIgnoreWidth', 'DISPID_SGRSAddWordTransition',
    'DISPID_SLWs_NewEnum', 'SPEI_RESERVED6', 'SREFalseRecognition',
    'ISpeechRecoResult', 'DISPID_SRGetPropertyNumber',
    'SSSPTRelativeToStart', 'SpeechVisemeFeature',
    'DISPID_SDKGetlongValue', 'DISPID_SpeechAudioBufferInfo',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechRecoResult2',
    'DISPID_SPIEnginePrivateData', 'SVSFParseMask', 'SPFM_NUM_MODES',
    'DISPID_SOTsCount', 'SRSActive', 'SPEI_SOUND_END', 'SpStream',
    'DISPID_SOTCSetId', 'DISPID_SABufferNotifySize',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SMSAMMHandle', 'DISPID_SpeechWaveFormatEx',
    'SVEEndInputStream', 'DISPID_SASNonBlockingIO',
    'DISPID_SPIAudioSizeTime', 'DISPID_SGRSTWeight',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechPhraseInfo',
    'ISpXMLRecoResult', 'DISPID_SpeechLexiconPronunciation',
    'SPEI_VISEME', 'SLODynamic', 'SpInprocRecognizer',
    'DISPID_SpeechPhraseRule', 'DISPID_SRRTimes',
    'SECFNoSpecialChars', 'DISPID_SOTGetStorageFileName',
    'SPEI_RESERVED1', 'SREPhraseStart', 'DISPID_SRGSetTextSelection',
    'SAFT8kHz16BitStereo', 'SPEI_RESERVED5', 'DISPID_SRGRecoContext',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRRRecoContext',
    'STSF_CommonAppData', 'DISPID_SRCEventInterests',
    'DISPID_SGRSAddRuleTransition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRGRules',
    'SAFTADPCM_8kHzStereo', 'DISPID_SGRName', 'SpLexicon',
    'SAFT8kHz8BitMono', 'SRTReSent', 'SINoSignal', 'SVEVoiceChange',
    'eLEXTYPE_PRIVATE9', 'SpInProcRecoContext',
    'DISPID_SOTCreateInstance', 'SVESentenceBoundary',
    'SAFT22kHz8BitMono', 'SpeechLexiconType',
    'DISPID_SpeechMemoryStream', 'SPPHRASEELEMENT', 'SPPS_Verb',
    'DISPID_SVDisplayUI', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechVoicePriority', 'SPEI_MIN_TTS', 'DISPID_SRDisplayUI',
    'DISPID_SABufferInfo', 'SP_VISEME_16', 'DISPID_SOTCDefault',
    'SP_VISEME_19', 'SpMemoryStream', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SVSLastBookmarkId', 'ISpeechLexiconPronunciations',
    'SPVPRIORITY', 'DISPID_SREmulateRecognition', '_SPAUDIOSTATE',
    'SpNotifyTranslator', 'SPXRO_Alternates_SML', 'SPINTERFERENCE',
    'DISPID_SpeechMMSysAudio', 'DISPID_SVVoice', 'SPWT_PRONUNCIATION',
    'SPDKL_CurrentConfig', 'SAFTCCITT_uLaw_8kHzStereo',
    'SDA_No_Trailing_Space', 'DISPID_SABIEventBias',
    'SPSERIALIZEDPHRASE', 'SPEI_END_INPUT_STREAM', 'SPAS_RUN',
    'SVP_1', 'SPEI_PHONEME', 'DISPID_SVEPhoneme',
    'DISPID_SVGetAudioOutputs', 'SVP_10', 'SASClosed',
    'DISPID_SpeechPhraseInfo', 'DISPID_SVWaitUntilDone',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SLGetGenerationChange',
    'eLEXTYPE_PRIVATE15', 'DISPID_SLWsCount', 'SVP_13', 'SRATopLevel',
    'SpeechDictationTopicSpelling', 'DISPIDSPTSI_SelectionLength',
    'SpeechGrammarWordType', 'ISpResourceManager',
    'DISPID_SpeechPhraseAlternates', 'SPSVerb', 'IEnumSpObjectTokens',
    'SECFDefault', 'SPEI_FALSE_RECOGNITION', 'SAFTGSM610_8kHzMono',
    'SpeechAudioFormatType', 'DISPID_SOTDisplayUI',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRSetPropertyString',
    'SECFEmulateResult', 'ISpeechPhraseReplacement', 'SPRULESTATE',
    'DISPID_SPRules_NewEnum', 'DISPID_SRSCurrentStreamPosition',
    'SDKLLocalMachine', 'SPEI_PHRASE_START', 'SVP_17',
    'DISPID_SLPs_NewEnum', 'DISPID_SpeechDataKey',
    'ISpNotifyTranslator', 'SP_VISEME_21',
    'DISPID_SRSSupportedLanguages', 'SVP_4', 'ISpeechGrammarRule',
    'ISpeechLexiconWord', 'SPXMLRESULTOPTIONS', 'SITooSlow', 'SVP_16',
    'DISPID_SGRSTPropertyId', 'SDTAlternates', 'SVSFParseSsml',
    'SAFT32kHz16BitMono', 'SpeechStreamSeekPositionType',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTCCITT_uLaw_11kHzStereo', 'SP_VISEME_5',
    'SpeechAudioProperties', 'SVP_12', 'SPINTERFERENCE_TOOFAST',
    'SPWORD', 'SpeechVoiceCategoryTTSRate', 'SPEI_SR_AUDIO_LEVEL',
    'SGDSActive', 'SPWF_SRENGINE', 'DISPID_SpeechRecoContext',
    'SRAORetainAudio', 'SpeechRecoProfileProperties',
    'DISPID_SVESentenceBoundary', 'SGLexical',
    ...
    'SPEI_START_INPUT_STREAM', 'ISpeechGrammarRuleState',
    'SAFT48kHz8BitMono', 'ISpeechPhraseRule',
    'DISPID_SpeechGrammarRuleStateTransition', 'SECFIgnoreCase',
    'DISPID_SAStatus', 'SpeechInterference', 'SAFT12kHz8BitMono',
    'SPPS_RESERVED3', 'eLEXTYPE_PRIVATE13', 'SpeechCategoryAudioOut',
    'DISPID_SWFEBlockAlign', 'SVP_20', 'SpeechEmulationCompareFlags',
    'DISPID_SVVolume', 'SPFM_CREATE', 'SPDKL_CurrentUser',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SRCreateRecoContext', 'DISPID_SPRuleConfidence',
    'DISPID_SVSLastStreamNumberQueued', 'SpFileStream',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRRTLength',
    'DISPID_SGRInitialState', 'SECLowConfidence', 'ISpSerializeState',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPGS_EXCLUSIVE',
    'DISPID_SRCRecognizer', 'SpeechAudioVolume',
    'ISpStreamFormatConverter', 'SVEStartInputStream', 'SP_VISEME_6',
    'SVSFDefault', 'DISPID_SVEViseme', 'SPRST_INACTIVE',
    ...
    'ISpeechDataKey', 'DISPID_SPAsCount', 'DISPIDSPTSI',
    'SpeechLoadOption', 'DISPID_SRRAudioFormat', 'ISpRecoCategory',
    'SPWT_LEXICAL', 'DISPID_SVSLastResult', 'DISPID_SGRSTNextState',
    'SP_VISEME_14', 'SPSHT_EMAIL', 'DISPID_SLPType', 'SPPS_Unknown',
    'DISPID_SOTId', 'DISPID_SPCIdToPhone', 'SRESoundEnd',
    'DISPID_SRRecognizer', 'SpeechDisplayAttributes',
    'DISPID_SRCVoicePurgeEvent', 'SRAONone', 'SVSFParseSapi',
    'eWORDTYPE_ADDED', 'DISPID_SGRAddState', 'SDTReplacement',
    'SpeechRuleAttributes', 'SAFT16kHz16BitStereo',
    'DISPID_SPPConfidence', 'eLEXTYPE_PRIVATE16', 'tagSTATSTG',
    'DISPID_SPIGrammarId', 'DISPID_SVSCurrentStreamNumber',
    'SPCT_DICTATION', 'DISPID_SRCEFalseRecognition', 'ISpEventSource',
    'SECNormalConfidence', 'DISPID_SWFEFormatTag',
    'DISPID_SVIsUISupported', 'SPRST_ACTIVE', 'SpeechRecognizerState',
    ...
    'DISPID_SVSInputWordPosition', 'SPBO_NONE', 'SVSFIsXML',
    'DISPID_SRRSpeakAudio', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPWORDTYPE', 'SFTSREngine', 'SAFTADPCM_44kHzMono', 'SVSFNLPMask',
    'eLEXTYPE_RESERVED4', 'SGDSActiveWithAutoPause',
    'DISPID_SLPsItem', 'DISPID_SDKSetBinaryValue', 'ISpeechAudio',
    'SpObjectToken', 'DISPID_SOTRemove', 'SRARoot',
    'DISPID_SRCCreateGrammar', 'SPWORDLIST', 'SpeechRegistryUserRoot',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechPhraseProperty',
    'DISPIDSPTSI_ActiveLength', 'ISpObjectWithToken',
    'SpWaveFormatEx', 'DISPID_SPRulesItem', 'ISpRecognizer',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFTADPCM_22kHzMono',
    'DISPID_SABIBufferSize', 'DISPID_SPIProperties',
    'SPFM_OPEN_READONLY', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRCEPropertyNumberChange', 'SSSPTRelativeToEnd',
    'DISPID_SRCEHypothesis', 'DISPID_SABIMinNotification',
    'ISpeechAudioFormat', 'DISPID_SOTCGetDataKey',
    'SAFT11kHz8BitMono', 'SGSEnabled', 'SVSFPersistXML',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SPPName',
    'SP_VISEME_15', 'SP_VISEME_4', 'DISPID_SRGDictationSetState',
    'SREPropertyNumChange', 'SPSNotOverriden',
    'SpeechWordPronounceable', 'DISPID_SPEAudioTimeOffset',
    'SVF_Emphasis', 'ISpeechPhraseAlternates', 'SpSharedRecognizer',
    'SAFTNoAssignedFormat', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPEsCount', 'SPPHRASERULE', 'SpPhoneticAlphabetConverter',
    'SPVOICESTATUS', 'DISPID_SPRulesCount', 'SAFT22kHz16BitMono',
    ...
    'SpResourceManager', 'SVP_6', 'DISPID_SVSpeak', 'SDTAll',
    'SGDisplay', 'DISPID_SPCPhoneToId', 'SPSMF_UPS',
    'DISPID_SRCVoice', 'SSFMCreateForWrite', 'eLEXTYPE_RESERVED7',
    'SPRECOGNIZERSTATUS', 'SPLEXICONTYPE', 'SRSActiveAlways',
    'DISPID_SpeechRecoResult2', 'SWPUnknownWordPronounceable',
    'DISPID_SGRSTsItem', 'DISPID_SRGState', 'SREInterference',
    'SPCT_SUB_COMMAND', 'SP_VISEME_1', 'DISPID_SVSLastBookmark',
    'DISPID_SpeechVoiceStatus', 'SP_VISEME_12', 'ISpeechCustomStream',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPPsItem', 'DISPID_SRGId',
    'SPEI_SR_BOOKMARK', 'DISPID_SPEs_NewEnum', 'SPSHT_Unknown',
    'ISpeechGrammarRules', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPRsItem', 'DISPID_SOTGetAttribute',
    'DISPID_SRGDictationLoad', 'ISpObjectTokenCategory', 'SWTDeleted',
    'DISPID_SVStatus', 'SLTUser', 'DISPID_SADefaultFormat',
    'SREPrivate', 'DISPID_SOTMatchesAttributes', 'DISPID_SBSWrite',
    'DISPID_SVRate', 'DISPID_SpeechPhraseElements', 'SPVPRI_NORMAL',
    'DISPID_SPEAudioSizeBytes',
    'SpeechPropertyHighConfidenceThreshold', 'eLEXTYPE_PRIVATE10',
    'ISpeechRecognizer', 'SVP_21', 'SPPS_NotOverriden', 'SPSModifier',
    'DISPID_SRAudioInputStream', 'DISPID_SRCEEndStream',
    'DISPID_SVAudioOutputStream', 'SPPS_Interjection',
    'SPEI_WORD_BOUNDARY', 'DISPID_SGRSTType',
    'DISPID_SVSInputSentencePosition', 'eLEXTYPE_RESERVED8',
    'SPSMF_SAPI_PROPERTIES', 'SPPS_RESERVED1', 'SPEI_HYPOTHESIS',
    'ISpeechXMLRecoResult', 'SPAS_STOP', 'eLEXTYPE_PRIVATE8',
    'SITooFast', 'SPAR_Unknown', 'DISPID_SRRTTickCount',
    'eLEXTYPE_PRIVATE19', 'SpMMAudioOut', 'SVPOver',
    'DISPID_SGRsCommitAndSave', 'DISPID_SVEAudioLevel', 'SLTApp',
    'SpeechCategoryRecognizers', 'DISPID_SGRSTPropertyName',
    'IInternetSecurityManager', 'SPSSuppressWord', 'ISpRecoContext2',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpCustomStream',
    'SpeechVoiceEvents', 'DISPID_SVGetAudioInputs',
    'SGDSActiveUserDelimited', 'SAFTText', 'SAFT44kHz16BitStereo',
    'SAFT24kHz8BitStereo', 'SPEI_START_SR_STREAM', 'ISpeechVoice',
    'DISPID_SPPValue', 'ISpeechGrammarRuleStateTransition',
    'Speech_StreamPos_RealTime', 'SpeechCategoryAudioIn',
    'DISPID_SRState', 'DISPID_SRCSetAdaptationData',
    'eLEXTYPE_PRIVATE20', 'ISpPhoneConverter', 'ISpGrammarBuilder',
    'SPEVENTENUM', 'DISPID_SRRSaveToMemory', 'SpeechRunState',
    'tagSPPROPERTYINFO', 'DISPID_SRCESoundEnd',
    'DISPID_SPIGetDisplayAttributes', 'SpeechAddRemoveWord',
    'SPEI_RECOGNITION', 'DISPID_SpeechLexiconWord', 'SRADynamic',
    'SPSLMA', 'DISPID_SPIRetainedSizeBytes', 'DISPID_SRCEPhraseStart',
    'ISpeechObjectTokenCategory', 'DISPID_SOTRemoveStorageFileName',
    'SPGRAMMARWORDTYPE', 'SASStop', 'SPEI_RESERVED3',
    'eLEXTYPE_PRIVATE17', 'SP_VISEME_18', 'SVSFVoiceMask',
    'SAFT16kHz8BitStereo', 'DISPID_SPERetainedStreamOffset',
    'SPGS_DISABLED', 'SPEI_TTS_BOOKMARK', 'SpUnCompressedLexicon',
    'SGRSTTRule', 'ISpRecognizer3', 'SREStreamEnd',
    'eLEXTYPE_RESERVED10', 'SpeechPropertyResourceUsage',
    'ISpDataKey', 'DISPID_SRGetRecognizers', 'SECHighConfidence',
    'eLEXTYPE_MORPHOLOGY', 'SAFT22kHz8BitStereo', 'STSF_LocalAppData',
    'ISpeechLexiconWords', 'SP_VISEME_11',
    'DISPID_SRRTOffsetFromStart', 'IEnumString',
    'DISPID_SRGDictationUnload', 'SVF_Stressed',
    'ISpeechPhraseProperties', 'ISpeechRecognizerStatus',
    'ISpMMSysAudio', 'DISPID_SVSInputWordLength',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SGRsFindRule', 'DISPID_SRIsShared',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechLexicon',
    'SAFT16kHz8BitMono', 'SDKLCurrentUser', 'SpeechTokenKeyUI',
    'DISPID_SOTs_NewEnum', 'SPLO_STATIC', 'SVEWordBoundary',
    'SpeechCategoryAppLexicons', 'SPPS_Modifier', 'SFTInput',
    'SP_VISEME_0', 'DISPID_SPIReplacements', 'eWORDTYPE_DELETED',
    'ISpRecoGrammar2', 'SPRS_INACTIVE', 'SPEI_TTS_PRIVATE',
    'SPEI_RECO_OTHER_CONTEXT', 'SpMMAudioIn', 'DISPID_SMSSetData',
    'DISPID_SPPEngineConfidence', 'DISPID_SPERequiredConfidence',
    'SPWF_INPUT', 'DISPID_SRCEBookmark', 'DISPID_SGRClear',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPEVENT',
    'SpeechUserTraining', 'ISpeechMemoryStream', 'SPAR_High',
    'eLEXTYPE_PRIVATE12', 'SRCS_Disabled', 'DISPID_SPAPhraseInfo',
    'ISpeechAudioStatus', 'SPWAVEFORMATTYPE', 'SVP_3',
    'ISpeechResourceLoader', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SPRuleParent', 'DISPID_SpeechFileStream',
    'DISPID_SOTsItem', 'DISPID_SpeechPhraseProperties', 'SPPHRASE',
    'ISpStream', 'SAFTNonStandardFormat', 'SpeechRecoContextState',
    'DISPID_SLPPhoneIds', 'SPRST_NUM_STATES',
    'DISPID_SASCurrentSeekPosition', 'ISpRecoContext', 'SPEI_MAX_TTS',
    'tagSPTEXTSELECTIONINFO', 'SAFT8kHz8BitStereo',
    'SAFTADPCM_44kHzStereo', 'DISPID_SLWWord', 'SAFT24kHz16BitStereo',
    'SPWORDPRONOUNCEABLE', 'DISPID_SLWsItem', 'DISPID_SFSOpen',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPAR_Low', 'SpShortcut',
    'SRAExport', 'SPFM_CREATE_ALWAYS', 'SDTProperty',
    'SpeechRegistryLocalMachineRoot', 'SPBINARYGRAMMAR',
    'SpeechTokenValueCLSID', 'eLEXTYPE_PRIVATE3', 'SP_VISEME_2',
    'SPPS_LMA', 'Speech_StreamPos_Asap', 'DISPID_SpeechObjectToken',
    'SPEI_MIN_SR', 'DISPID_SRGCmdLoadFromFile', 'SPAO_RETAIN_AUDIO',
    'SpeechTokenKeyAttributes', 'SRERecognition', 'STCAll',
    'DISPID_SASFreeBufferSpace', 'DISPID_SpeechGrammarRule',
    'DISPID_SVSpeakCompleteEvent', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPIEngineId', 'DISPID_SRSClsidEngine',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SGRsItem',
    'DISPID_SDKDeleteValue', 'SpeechRecoEvents', 'SSFMCreate',
    'SPEVENTSOURCEINFO', 'DISPID_SGRId', 'SITooLoud',
    'DISPID_SPIAudioStreamPosition', 'SVEAudioLevel',
    'DISPID_SRRSetTextFeedback', 'DISPID_SMSGetData',
    'SPPARTOFSPEECH', 'DISPID_SRCState', 'DISPID_SWFESamplesPerSec',
    'DISPID_SLWLangId', 'DISPID_SpeechRecoResultTimes',
    'SAFTGSM610_22kHzMono', 'ISpeechPhraseProperty', 'SDTDisplayText',
    'DISPID_SAFType', 'DISPID_SPPsCount', 'DISPID_SRRPhraseInfo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpeechFormatType',
    'DISPID_SRCRetainedAudioFormat', 'SGSDisabled',
    'DISPID_SRCResume', 'SSTTWildcard', 'SPVPRI_OVER',
    'DISPID_SPRDisplayAttributes', 'SAFTExtendedAudioFormat',
    'SPEI_REQUEST_UI', 'eLEXTYPE_PRIVATE6',
    'DISPID_SLGetPronunciations', 'SRAInterpreter', 'SBOPause',
    'SPADAPTATIONRELEVANCE', 'ISpeechPhraseElements',
    'DISPID_SVEBookmark', 'SpeechEngineConfidence', 'SREAllEvents',
    'ISpLexicon', 'DISPID_SWFEAvgBytesPerSec', 'ISpRecoGrammar',
    'DISPID_SPRuleFirstElement', 'SpeechRuleState', 'SVP_9',
    'DISPID_SGRSTRule', 'ISpEventSink', 'DISPID_SGRSTransitions',
    'SRTStandard', 'SPEI_SR_PRIVATE', 'SpeechCategoryRecoProfiles',
    'SPEI_VOICE_CHANGE', 'SPEI_INTERFERENCE',
    'DISPID_SRRGetXMLResult', 'DISPID_SAVolume', 'IStream',
    'DISPID_SDKSetLongValue', 'DISPID_SPIAudioSizeBytes', 'SPPS_Noun',
    'SAFT44kHz8BitMono', 'SAFTCCITT_ALaw_8kHzMono', 'SDTLexicalForm',
    'SpeechVoiceSpeakFlags', 'DISPID_SPIRule', 'DISPID_SMSADeviceId',
    'DISPID_SBSRead', 'SVEPrivate', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SpeechPhraseAlternate', 'SpSharedRecoContext',
    'SVSFIsFilename', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRSAudioStatus', 'SPEI_SOUND_START', 'SGRSTTEpsilon',
    'SAFTCCITT_ALaw_22kHzStereo', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SBSFormat', 'DISPID_SPACommit',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SGRAddResource',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SpeechRecoResult',
    'SPRULE', 'DISPIDSPRG', 'SpeechTokenShellFolder',
    'DISPID_SPRuleChildren', 'SPDKL_DefaultLocation',
    'DISPID_SRSetPropertyNumber', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SpeechLexiconWords', 'ISpStreamFormat', 'SPPS_Noncontent',
    'ISpeechMMSysAudio', 'SRADefaultToActive', 'ISpeechObjectToken',
    'ISpPhraseAlt', 'SPEI_RECO_STATE_CHANGE', 'DISPID_SPELexicalForm',
    'SPXRO_SML', 'DISPID_SPRuleName', 'DISPID_SRCBookmark', 'SVP_0',
    'SDTAudio', 'eLEXTYPE_VENDORLEXICON', 'DISPID_SLPPartOfSpeech',
    'ISpNotifySink', 'SPTEXTSELECTIONINFO', 'SRTSMLTimeout',
    'DISPID_SPAsItem', 'DISPID_SPCLangId', 'ISpeechPhoneConverter',
    'SPPS_SuppressWord', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRGReset', 'SAFTGSM610_11kHzMono', 'SVSFUnusedFlags',
    'DISPID_SRCRetainedAudio', 'SPCT_COMMAND', 'DISPID_SVResume',
    'DISPID_SPISaveToMemory', 'DISPID_SGRSTPropertyValue',
    'SGPronounciation', 'SGRSTTWildcard', 'DISPID_SpeechAudioFormat',
    'SpeechMicTraining', 'DISPID_SVEStreamStart', 'DISPID_SPRuleId',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SpeechVoice',
    'SVSFParseAutodetect', 'DISPID_SpeechGrammarRules',
    'SpObjectTokenCategory', 'SVP_15', 'SREHypothesis',
    'SpeechAudioFormatGUIDText', 'DISPID_SBSSeek',
    'DISPID_SRCEInterference', 'DISPID_SRSCurrentStreamNumber',
    'IInternetSecurityMgrSite', 'DISPID_SLAddPronunciation',
    'SRTExtendableParse', 'DISPID_SPEEngineConfidence', 'SVP_18',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SLPsCount',
    'SpeechRecognitionType', 'UINT_PTR', 'DISPID_SGRSTText',
    'ISpeechRecoResultDispatch', 'SREPropertyStringChange',
    'DISPID_SpeechAudioStatus', 'SPCT_SUB_DICTATION',
    'eLEXTYPE_PRIVATE7', 'DISPID_SVSkip', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpMMAudioEnum', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechRecognizerStatus', 'SpeechWordType',
    'STSF_FlagCreate', 'SVP_5', 'SPINTERFERENCE_TOOSLOW',
    'SECFIgnoreKanaType', 'LONG_PTR', 'SPAUDIOSTATE',
    'DISPID_SRCERecognition', 'DISPID_SpeechPhraseRules',
    'DISPID_SPRs_NewEnum', 'DISPID_SGRsCount',
    'DISPID_SRCERecognitionForOtherContext', 'SpCompressedLexicon',
    'SpPhoneConverter', 'SASPause', 'DISPID_SLPLangId', 'ISpPhrase',
    'ISpAudio', 'SLOStatic', 'SPBOOKMARKOPTIONS',
    'SpeechGrammarState', 'DISPID_SPPChildren', 'ISpRecognizer2',
    'DISPID_SRCEStartStream', 'SGRSTTWord', 'SPPS_Function',
    'DISPIDSPTSI_SelectionOffset', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPAUDIOOPTIONS', 'SpeechCategoryVoices',
    'ISpeechTextSelectionInformation', 'SPPHRASEPROPERTY',
    'SPRECORESULTTIMES', 'SVEBookmark', 'SVP_19',
    'SAFTADPCM_11kHzMono', 'SAFTADPCM_8kHzMono', 'SPDATAKEYLOCATION',
    'ISpeechPhraseElement', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SVEWord', 'DISPID_SPRsCount', 'SWTAdded',
    'SpeechVisemeType', 'SPSEMANTICFORMAT', 'eLEXTYPE_PRIVATE2',
    'SAFTCCITT_uLaw_44kHzMono', 'SVPNormal', 'eLEXTYPE_USER',
    'eLEXTYPE_RESERVED9', 'SAFTTrueSpeech_8kHz1BitMono',
    'eLEXTYPE_PRIVATE14', 'SRAImport', 'SPAUDIOBUFFERINFO',
    'DISPID_SASState', 'DISPID_SDKOpenKey', 'DISPID_SOTCId',
    'DISPID_SPRuleNumberOfElements', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechObjectTokens', 'SPCS_DISABLED',
    'SPSERIALIZEDRESULT', 'SPSFunction',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRRAlternates',
    'SpeechTokenKeyFiles', 'SAFTCCITT_ALaw_44kHzStereo',
    'SAFT48kHz16BitMono', 'DISPID_SRCPause', 'SAFT12kHz16BitMono',
    'SPGS_ENABLED', 'SWPKnownWordPronounceable', 'SPVISEMES',
    'STCRemoteServer', 'DISPID_SMSALineId',
    'DISPID_SpeechLexiconProns', 'SAFT11kHz16BitMono',
    'DISPID_SRGetPropertyString', 'SpeechAudioState',
    'DISPID_SRProfile', 'DISPID_SPPNumberOfElements', 'SP_VISEME_10',
    'DISPID_SDKDeleteKey', 'SVPAlert', 'SAFT8kHz16BitMono',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPAUDIOSTATUS',
    'ISpeechRecoGrammar', 'DISPID_SOTSetId', 'Speech_Max_Word_Length',
    'ISpPhoneticAlphabetConverter', 'DISPID_SpeechPhoneConverter',
    'DISPID_SPEDisplayText', 'SPLOADOPTIONS', 'SPAS_CLOSED',
    'ISpeechVoiceStatus', 'SpeechPropertyComplexResponseSpeed',
    'SpeechBookmarkOptions', 'DISPID_SOTGetDescription',
    'SPSInterjection', 'DISPID_SGRSRule', 'DISPID_SGRsDynamic',
    'SVSFPurgeBeforeSpeak', 'SPPS_RESERVED2', 'SAFT11kHz16BitStereo',
    'DISPID_SVSPhonemeId', 'SAFT32kHz8BitMono', 'DISPID_SVSVisemeId',
    'DISPID_SPRText', 'SP_VISEME_8', 'SPGRAMMARSTATE',
    'SRESoundStart', 'DISPID_SpeechLexicon', 'DISPID_SOTDataKey',
    'ISpeechRecoContext', 'SREAudioLevel', 'SPCONTEXTSTATE',
    'SPINTERFERENCE_TOOQUIET', 'SPRECOSTATE', 'DISPID_SPEsItem',
    'SPWT_DISPLAY', 'DISPID_SLPSymbolic', 'DISPID_SRAudioInput',
    'SVP_14', 'SPAR_Medium', 'SAFT16kHz16BitMono',
    'DISPID_SRGetFormat', 'SpeechDiscardType',
    'DISPID_SPANumberOfElementsInResult', 'SRSInactiveWithPurge',
    'SWPUnknownWordUnpronounceable', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRGIsPronounceable', 'SVF_None',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'eLEXTYPE_PRIVATE11',
    'SpeechDataKeyLocation', 'SPBO_PAUSE', 'ISpProperties',
    'SPFM_OPEN_READWRITE', 'DISPID_SRCRequestedUIType', 'SPBO_AHEAD',
    'SGSExclusive', 'SPEI_ADAPTATION', 'SpAudioFormat',
    'SGRSTTTextBuffer', 'SpVoice', 'SPSNoun',
    'DISPID_SLRemovePronunciation', 'ISpPhoneticAlphabetSelection',
    'SRSEDone', 'DISPID_SPIStartTime', 'DISPID_SVPause',
    'SRSEIsSpeaking', 'SRERecoOtherContext', 'SVEViseme',
    'SPVPRI_ALERT', 'SpeechCategoryPhoneConverters', 'STSF_AppData',
    'DISPIDSPTSI_ActiveOffset', 'SpeechAudioFormatGUIDWave',
    'SpeechEngineProperties', 'ISpeechPhraseReplacements',
    'SPSHORTCUTTYPE', 'DISPID_SVEventInterests',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SPAStartElementInResult', 'SPINTERFERENCE_NOISE',
    'DISPID_SPRFirstElement', 'SPSHT_NotOverriden',
    'SDA_One_Trailing_Space', 'Speech_Default_Weight',
    'DISPID_SDKEnumValues', 'DISPID_SDKGetBinaryValue',
    'SVSFlagsAsync', 'SP_VISEME_3', 'DISPID_SpeechAudio',
    'DISPID_SVAudioOutput', 'DISPID_SOTCategory',
    'SAFT22kHz16BitStereo', 'SVP_11', 'SPAO_NONE',
    'DISPID_SpeechBaseStream', 'DISPID_SPARecoResult', 'SPAS_PAUSE',
    'DISPID_SGRSTs_NewEnum', 'SVEPhoneme', 'SGRSTTDictation',
    'DISPID_SVGetVoices', 'DISPID_SAEventHandle', 'SP_VISEME_20',
    'DISPID_SPERetainedSizeBytes', 'WAVEFORMATEX',
    'eLEXTYPE_PRIVATE5', 'SPRS_ACTIVE',
    'DISPID_SpeechObjectTokenCategory', 'SpeechPartOfSpeech',
    'SPEI_RESERVED2', 'DISPID_SDKGetStringValue',
    'DISPID_SRRTStreamTime', 'ISpeechFileStream', 'DISPID_SVPriority',
    'SRSInactive', 'DISPID_SRCERequestUI',
    'DISPID_SRGCmdLoadFromResource', 'ISpVoice', 'SRERequestUI',
    '_RemotableHandle', '__MIDL_IWinTypes_0009',
    'DISPID_SpeechRecognizer', 'SPSTREAMFORMATTYPE', 'STCLocalServer',
    'ISpeechPhraseRules', 'SPEI_END_SR_STREAM', 'SREBookmark',
    'SREStateChange', 'SAFT44kHz8BitStereo', 'DISPID_SASetState',
    'SPBO_TIME_UNITS', 'SAFT44kHz16BitMono', 'SVP_8',
    'SSSPTRelativeToCurrentPosition', 'SGLexicalNoSpecialChars',
    'DISPID_SRIsUISupported', 'SSTTTextBuffer', 'SBONone',
    'DISPID_SRStatus', 'SAFT32kHz16BitStereo', 'SVP_2',
    'SPPHRASEREPLACEMENT', 'DISPID_SRSNumberOfActiveRules',
    'ISpeechLexiconPronunciation', 'DISPID_SCSBaseStream',
    'DISPID_SVEStreamEnd', 'SAFT24kHz8BitMono',
    'DISPID_SRRGetXMLErrorInfo', 'ISpeechPhraseInfoBuilder',
    'SPDKL_LocalMachine', 'DISPID_SDKCreateKey', 'DISPID_SDKEnumKeys',
    'DISPID_SFSClose', 'DISPID_SAFGuid', 'ISpObjectToken',
    'DISPID_SPEDisplayAttributes', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRGCommit', 'DISPID_SPIElements', 'ISpeechWaveFormatEx',
    'SSFMOpenReadWrite', 'SPEI_TTS_AUDIO_LEVEL', 'SPCS_ENABLED',
    'SSTTDictation', 'SAFT11kHz8BitStereo', 'eLEXTYPE_PRIVATE18',
    'DISPID_SGRSAddSpecialTransition', 'SpeechAllElements',
    'SRCS_Enabled', 'DISPID_SPPParent', 'DISPID_SVSRunningState',
    'DISPID_SGRAttributes', 'SAFTDefault', 'DISPID_SPAs_NewEnum',
    'SDA_Two_Trailing_Spaces', 'SpPhraseInfoBuilder',
    'DISPID_SPPFirstElement', 'SPEI_SENTENCE_BOUNDARY', 'SASRun',
    'SVSFIsNotXML', 'SPINTERFERENCE_NOSIGNAL', 'SSFMOpenForRead',
    'SINoise', 'DISPID_SWFEChannels', 'ISequentialStream',
    'SPEI_UNDEFINED', 'SAFTCCITT_ALaw_8kHzStereo', 'SRTAutopause',
    'SPSHORTCUTPAIR', 'DISPID_SpeechXMLRecoResult',
    'SpeechGrammarTagWildcard', 'DISPID_SpeechPhraseBuilder',
    '_ISpeechVoiceEvents', 'SP_VISEME_13', 'DISPID_SVEVoiceChange',
    'SAFT48kHz16BitStereo', 'SpeechGrammarTagDictation',
    'SREStreamStart', 'SPRST_INACTIVE_WITH_PURGE',
    'SPINTERFERENCE_NONE', 'SPCT_SLEEP', 'DISPID_SPEPronunciation',
    'SPSHT_OTHER', 'DISPID_SpeechPhraseReplacements',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SGRsAdd',
    'DISPID_SGRs_NewEnum', 'DISPID_SPILanguageId',
    'DISPID_SVEEnginePrivate', 'DISPID_SLGetWords',
    'SAFT12kHz16BitStereo', 'SpeechTokenContext',
    'DISPID_SVAlertBoundary', 'SPWORDPRONUNCIATION', 'SPLO_DYNAMIC',
    'SAFT12kHz8BitStereo', 'SVP_7', 'SDTRule',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SVSpeakStream',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRGCmdLoadFromMemory',
    'SDA_Consume_Leading_Spaces', 'DISPID_SPPId', 'DISPID_SRRAudio',
    'SP_VISEME_17', 'SITooQuiet', 'DISPID_SLGenerationId',
    'DISPID_SOTIsUISupported', 'DISPID_SRCESoundStart',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpNotifySource', 'SPPS_RESERVED4',
    'ISpRecoResult', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SpeechVoiceEvent', 'SPFILEMODE', 'STCInprocHandler',
    'SpeechSpecialTransitionType',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SINone',
    'SAFTADPCM_11kHzStereo', 'DISPID_SDKSetStringValue',
    'SpeechStreamFileMode', 'DISPID_SpeechPhraseElement',
    'SPCATEGORYTYPE', 'DISPID_SpeechCustomStream',
    'SpeechPropertyResponseSpeed', 'SPEI_MAX_SR',
    'SpNullPhoneConverter', 'DISPID_SLWType', 'SP_VISEME_9',
    'eLEXTYPE_PRIVATE4', 'DISPID_SLWPronunciations'
]

_check_version('1.2.0', 1625150554.634525)
